    ...
    <div class="form-control">
      ...
      <ha-card class="${w}">
        ...
        >
          ...
          <button
            class="water-button"
            @click="${t=>this._handleWaterClick(t)}"
