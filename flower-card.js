      ...
      ${v?n.html`<div
          ...
          >
            <span
              ...
              style="${$&&h?`color: ${g}`:""}"
              >${p}</span
            >&nbsp;<span class="unit">${(0,a.unsafeHTML)(y)}</span>
          </div>`:""}
    </div>
