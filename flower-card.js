      ...
      ${_?n.html`<div
          ...
          >
            <span
              ...
              style="${w?`color: ${p}`:""}"
              >${h}</span
            >&nbsp;<span class="unit">${(0,a.unsafeHTML)(g)}</span>
          </div>`:""}
    </div>
