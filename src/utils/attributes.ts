...
export const renderWateringStatus = (card: FlowerCard) => {
  const watering = card.plantinfo?.result?.watering as WateringInfo;
  ...
  return html`
    <div
      ...
      @click="${() => moreInfo(card, card.stateObj.entity_id)}"
    >
      ...
      <div class="health-row">
              ...
              >
                ...
                <div class="health-bar-bg">
                  <div
                    ...
                    style="width: ${health.comfort_score}%; background-color: ${health.comfort_score >
                    80
                      ? "var(--success-color, #43a047)"
                      : health.comfort_score > 50
        ...
        ${watering.explanation
          ? html`
              <div class="watering-explanation">${watering.explanation}</div>
            `
          : ""}
      </div>
    </div>
